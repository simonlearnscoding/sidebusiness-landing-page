    ...
    <section id={id}>
      <div className="relative w-screen h-screen bg-white">
        ...
        <div className="flex h-full flex-col">
          <div className="mt-36 ml-24 font-bebas text-7xl text-zinc-400">
            HAVE SOME COOL IDEAS?{" "}
          </div>

          <h1 className="mb-10 ml-24 font-bebas  text-zinc-950">
            Let&apos;s HAVE A CHAT
          </h1>
          ...
          <a
            ...
            className="mt-auto py-10 cursor-pointer  bg-primary-500 w-full text-9xl flex items-center justify-start pl-24 overflow-hidden relative group"
          >
