...
function Service({ Icon, name, bullets }) {
  return (
    <div className=" p-5 lg:p-14  flex hover:bg-gradient-to-tr hover:from-gray-900 hover:to-gray-800 transition-all   lg:flex-1 h-full   bg-gray-800 rounded-3xl border-solid border-[2px]  border-gray-900 hover:border-white   flex-col">
