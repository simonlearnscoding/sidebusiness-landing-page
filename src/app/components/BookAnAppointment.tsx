...
export default function BookAnAppointment() {
  return (
    <div className="flex mt-2 lg:mt-16 mb-8 lg:mb-20 mx-4 rounded-3xl bg-primary-600 lg:mx-20      flex-col ">
      <div className="mx-4 lg:mx-20">
        ...
        <button className="mb-7 lg:mb-24 items-center gap-3 justify-center flex mt-14 bg-dark font-sans w-full lg:w-fit shadow-lg text-2xl font-medium rounded-xl text-white py-5 px-5 ">
